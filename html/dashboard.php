                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <div class="tab-content">
                                ...
                                {
                                    if (strlen($_POST["update_password"]) > 16 || preg_match('/\W/', $_POST["update_password"]) )
                                    ...
                                    $password0 = $_POST["old_password"];
                                    $password1 = $_POST["update_password"];
                                    $username1 = $_POST["update_username"];
     
                                    if($username1 != $_SESSION['username'])
                                    {
                                     echo "<script>alert('用户名错误');location.href='./dashboard.php';</script>";
                                    }
                                    if($_SESSION['password'] == $password0)
                                    {
                                    mysqli_query($conn,"UPDATE member SET password='$password1' WHERE username='$username1'");
                                    echo "<script>alert('修改成功');location.href='./dashboard.php';</script>";
                                   }else{
                                         echo "<script>alert('密码错误');location.href='./dashboard.php';</script>";
                                        }
                                }
